...
var VideoPlayer = $hx_exports["VideoPlayer"] = function(state) {
	...
	this.addCommand("goto-end",function(e1) {
		return _gthis.video.currentTime = _gthis.video.duration;
	});
	this.addCommand("rate-increase",function(e2) {
		var _gthis1 = _gthis.video;
		_gthis1.playbackRate += 0.1;
		return _gthis1.playbackRate;
	});
	this.addCommand("rate-decrease",function(e3) {
		var _gthis2 = _gthis.video;
		_gthis2.playbackRate -= 0.1;
		return _gthis2.playbackRate;
	});
	this.addCommand("toggle-controls",function(e4) {
		return _gthis.video.controls = !_gthis.video.controls;
	});
...
VideoPlayer.provideControls = function() {
