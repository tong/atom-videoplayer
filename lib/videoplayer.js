...
var VideoPlayer = function(state) {
	...
	this.commands.add(atom.commands.add(this.element,"videoplayer:" + "playbackrate-increase",function(e) {
		_gthis.playbackRate += 1;
		if(_gthis.playbackRate > 20) {
			_gthis.playbackRate = 20;
		}
		_gthis.video.playbackRate = _gthis.playbackRate / 10;
		_gthis.updateStatusbar();
	}));
	this.commands.add(atom.commands.add(this.element,"videoplayer:" + "playbackrate-decrease",function(e) {
		_gthis.playbackRate -= 1;
		if(_gthis.playbackRate < 1) {
			_gthis.playbackRate = 1;
		}
		_gthis.video.playbackRate = _gthis.playbackRate / 10;
		_gthis.updateStatusbar();
	...
	this.commands.add(atom.commands.add(this.element,"videoplayer:" + "screenshot",function(e) {
		...
		js_node_Fs.writeFile(path,dataURI,{ encoding : "base64"},function(e) {
			if(e != null) {
				console.log("src/VideoPlayer.hx:184:",e);
...
VideoPlayer.prototype = {
	...
	,updateStatusbar: function() {
		if(this.video == null) {
			...
			var info = "Size:" + this.video.videoWidth + "x" + this.video.videoHeight;
			info += ", Playbackrate x " + this.playbackRate / 10;
			VideoPlayer.statusbar.textContent = info;
		}
	}
