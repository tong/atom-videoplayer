...
var VideoPlayer = function(state) {
	...
	atom.config.onDidChange("videoplayer.background",function(e10) {
		var tmp = e10.newValue.transparent ? null : e10.newValue.color.toHexString();
		return _gthis.element.style.background = tmp;
	});
	atom.config.onDidChange("videoplayer.scale",function(e11) {
		_gthis.setScaleMode(e11.newValue);
		return;
	});
	if(state != null) {
		if(state.time != null) {
...
VideoPlayer.prototype = {
	...
	,handleVideoError: function(e) {
		console.error(e);
		atom.notifications.addError("Cannot play video",{ detail : this.getPath(), dismissable : true, icon : "file-media"});
	}
