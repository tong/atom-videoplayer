...
var VideoPlayer = function(path) {
	this.wheelSpeed = 1.0;
	this.seekFastFactor = 10.0;
	this.seekFactor = 30.0;
	this.path = path;
...
VideoPlayer.prototype = {
	...
	,destroy: function() {
		...
		this.view.destroy();
		this.view.video.removeEventListener("canplay",$bind(this,this.handleCanPlay));
...
VideoPlayerView.prototype = {
	...
	,seek: function(time) {
		if(this.video.currentTime != null) this.video.currentTime = this.video.currentTime + time;
	}
};
...
Main.config = { autoplay : { 'title' : "Autoplay", 'type' : "boolean", 'default' : true}, loop : { 'title' : "Loop video", 'type' : "boolean", 'default' : false}, volume : { 'title' : "Default Volume", 'type' : "number", 'default' : 0.7, 'minimum' : 0.0, 'maximum' : 1.0}};
